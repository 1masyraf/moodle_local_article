...
use local_article\manage;

require_once(__DIR__ . '/../../config.php');
// require_once('C:\Moodle\server\moodle\local\article\templates\view.mustache');


global $DB; //*IMPORTANT* This is needed for querying the database without writing direct statements

$PAGE-> set_url(new moodle_url('/local/article/delete.php')); //set the url to the page
